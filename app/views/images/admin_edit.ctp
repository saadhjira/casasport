				...
				<table>
					<tr>
						<td style="margin:5px;">
							...
							<?php
							if(!empty($this->data['Image']['photo_file_path'])){  
							 echo $this->Html->image('/attachments/images/small/' .$this->data['Image']['photo_file_path'], array('style' => 'margin:5px;') ); 
							 echo $this->Form->hidden('photo_file_path');
							}
							?>
